# Generated by Powerlevel10k configuration wizard on 2022-08-31 at 13:02 CEST.
...
# left frame, darkest-ornaments, sparse, few icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_TOOLBOX_CONTENT_EXPANSION='${P9K_TOOLBOX_NA👨:#fedora-toolbox-*}'
  # Custom icon.
